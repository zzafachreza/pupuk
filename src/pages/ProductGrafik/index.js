...
export default function LaporanHarian({ navigation, route }) {
    ...
    return (
        <SafeAreaView
            ...
            <WebView
                ...
                source={{
                    uri:
                        'https://zavalabs.com/pupuk/api/grafik_product.php?id_barang=' +
                        item.id_barang + '&width=' + windowWidth + '&height=' + windowHeight,
                }}
            />
